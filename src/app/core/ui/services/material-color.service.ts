...
export class MaterialColorService {
  ...
  /** App theme */
  themeClass = 'fem-readup-red-theme';
  /** Primary palette */
  primaryPalette = PaletteType.FEM_READUP_RED;
  /** Accent palette */
  accentPalette = PaletteType.FEM_READUP_RED;
  ...
  initializeTheme(theme: string) {
    switch(theme) {
      case "red" : {
        this.themeClass = 'fem-readup-red-theme';
        this.primaryPalette = PaletteType.FEM_READUP_RED;
        this.accentPalette = PaletteType.FEM_READUP_RED;
        break;
      }
    }
  }
